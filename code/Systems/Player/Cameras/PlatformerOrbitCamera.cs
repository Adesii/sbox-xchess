...
namespace Chess;
//Camera logic Taken from sbox-platformer :)
public class PlatformerOrbitCamera : PlayerCamera
{
	...
	public override void Update( Player player )
	{
		...
		center += -pawn.LookInput.Forward * 8f;
		var targetPos = center + -pawn.LookInput.Forward * targetDistance;
		...
		var endpos = center + -pawn.LookInput.Forward * distance;

		Camera.Position = endpos;
		Camera.Rotation = pawn.LookInput.ToRotation();
